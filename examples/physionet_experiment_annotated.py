"""
This is their example. Just run it and copy over the shapes into comments in the code so I can reference on another monitor.

Want to make sure I'm getting the channels of my data correctly for now.
...
#subjects = range(68)
# need less for VRAM issues, this code just loads all 68 subjects into memory at once ...
...
#X_train shape is list of 32, each of shape (~2600 - 2800, 2, 3000), 2 is the number of channels
